...
def prepare_image() -> ErrorCode:
    ...
    # Ensure ffmpeg will overwrite existing files when copying the image
    if ffmpeg.copy_image(
        state_manager.get_item("target_path"), temp_image_resolution, overwrite=True
    ):
